...
public class Ticket {
    ...
    public static String buscarEventos(String ciudad, String person_id){
    ...
    public static String buscarFecha(String categoria,String person_id){
    ...
    public static String buscarLugar(String fecha,String person_id){
    ...
    public static String buscarBoletas(String lugar,String person_id){
